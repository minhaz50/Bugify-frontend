...
const posts = [
  {
    id: 1,
    title: "Why We Ditched ORMs for Raw SQL in Bugify",
    excerpt:
      "We made the controversial decision to use raw SQL queries with pg driver instead of Prisma or TypeORM. Here's why it was the right call and what we learned.",
  ...
  },
  {
    id: 2,
    title:
      "Role-Based Access Control: How We Designed the Contributor / Maintainer System",
    excerpt:
      "Building a simple but powerful permission system with JWT tokens and middleware. Lessons from designing Bugify's auth layer.",
    category: "Product",
    date: "2026-06-28",
    readTime: "6 min read",
    color:
  ...
  },
  {
    ...
    excerpt:
      "Growing a developer tool requires thinking differently about onboarding. Here are the 5 lessons that made the biggest difference for Bugify's growth.",
    category: "Growth",
    date: "2026-06-10",
    readTime: "5 min read",
    color:
  ...
  },
  {
    ...
    excerpt:
      "Dark mode is more than just swapping colors. Here's how we built a proper theming system with CSS variables, class strategy, and zero flash.",
    category: "Engineering",
    date: "2026-05-22",
  ...
  },
  {
    ...
    excerpt:
      "Feature bloat kills productivity. We explored why many teams are moving away from Jira-style trackers toward simpler tools — and what that means for the future.",
    category: "Opinion",
    date: "2026-05-05",
    readTime: "7 min read",
    color:
  ...
  },
  {
    ...
    excerpt:
      "CORS, environment variables, connection pooling, and cold starts — everything you need to check before shipping your Node.js + Next.js app to production.",
    category: "DevOps",
    date: "2026-04-18",
      ...
      <section className="pt-32 pb-16 px-4 bg-gradient-to-br from-indigo-50 via-white to-purple-50 dark:from-slate-950 dark:via-slate-900 dark:to-indigo-950">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold text-slate-900 dark:text-white mb-4">
            Stories from the Bugify team
          </h1>
          <p className="text-lg text-slate-500 dark:text-slate-400">
            Engineering deep-dives, product decisions, and lessons learned
        ...
        <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2">
              <div className="h-64 lg:h-auto bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center">
                <div className="text-center text-white p-8">
                  <div className="text-6xl font-extrabold opacity-20 mb-2">
                    01
                  </div>
              ...
              <div className="p-8 flex flex-col justify-center">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <div
                      className={`w-7 h-7 rounded-full bg-gradient-to-br ${posts[0].gradient} flex items-center justify-center text-white text-xs font-bold`}
                    >
                      {posts[0].initials}
                    </div>
                    <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {posts.slice(1).map((post) => (
              <div
                key={post.id}
                className="card overflow-hidden hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 group flex flex-col"
              >
                <div
                  className={`h-40 bg-gradient-to-br ${post.gradient} flex items-center justify-center`}
                >
                ...
                <div className="p-5 flex flex-col flex-1">
                  <div className="flex items-center gap-2 mb-3">
                    <span className={`badge ${post.color}`}>
                      <Tag className="w-3 h-3" />
                      {post.category}
                    </span>
                  </div>
                  ...
                  <div className="flex items-center justify-between pt-3 border-t border-slate-100 dark:border-slate-700">
                    <div className="flex items-center gap-2">
                      <div
                        className={`w-6 h-6 rounded-full bg-gradient-to-br ${post.gradient} flex items-center justify-center text-white text-xs font-bold`}
                      >
                        {post.initials}
                      </div>
