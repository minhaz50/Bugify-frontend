...
const features = [
  {
    icon: Bug,
    title: "Bug Tracking",
    desc: "Report and track bugs with detailed descriptions, reproduction steps, and status updates.",
    color: "text-red-500 bg-red-50 dark:bg-red-900/20",
  },
  {
    icon: Sparkles,
    title: "Feature Requests",
    desc: "Suggest and vote on new features. Keep your product roadmap aligned with user needs.",
    color: "text-blue-500 bg-blue-50 dark:bg-blue-900/20",
  },
  {
    icon: Shield,
    title: "Role-Based Access",
    desc: "Contributors submit issues. Maintainers manage, resolve, and control the full workflow.",
    color: "text-indigo-500 bg-indigo-50 dark:bg-indigo-900/20",
  },
  {
    icon: BarChart3,
    title: "Analytics Dashboard",
    desc: "Visual charts and stats that give your team instant clarity on project health.",
    color: "text-amber-500 bg-amber-50 dark:bg-amber-900/20",
  },
  {
    icon: Users,
    title: "Team Collaboration",
    desc: "Built for teams. Everyone stays on the same page with shared visibility.",
    color: "text-emerald-500 bg-emerald-50 dark:bg-emerald-900/20",
  },
  {
    icon: Lock,
    title: "Secure by Default",
    desc: "JWT authentication, bcrypt password hashing, and role enforcement on every endpoint.",
...
const testimonials = [
  {
    ...
    text: "Bugify transformed how our team handles bugs. The role-based workflow means nothing slips through the cracks.",
    rating: 5,
  },
  {
    name: "Marcus Ali",
    role: "CTO, Vercel Labs",
    text: "Clean UI, fast API, and the dashboard charts give me exactly the visibility I need every morning.",
    rating: 5,
  },
  {
    name: "Priya Sharma",
    role: "Product Manager, Linear",
    text: "Our resolution time dropped by 40% in the first month. The feature request workflow is incredibly intuitive.",
    rating: 5,
  },
];
...
const faqs = [
  {
    ...
    a: "Contributors can create and manage their own issues. Maintainers have full control — they can update any issue, change its status, and delete issues. Roles are assigned at registration.",
  },
  {
    q: "Is there a free plan?",
    a: "Yes! Bugify is open source. You can self-host it for free or use our hosted version with generous limits for small teams.",
  },
  {
    q: "How is the JWT token used?",
    a: "After login, you receive a token that must be attached to the Authorization header on all protected API requests. No Bearer prefix required — just the raw token.",
  },
  {
    q: "Can I integrate Bugify with other tools?",
    a: "The REST API is fully documented and accessible, making it straightforward to integrate with GitHub, Slack, or any other tools your team uses.",
  },
  {
    q: "What happens when I change an issue status?",
    a: "Status changes are maintainer-only. Options are: open → in_progress → resolved. Each change timestamps updated_at automatically.",
  },
];
...
const steps = [
  {
    step: "01",
    title: "Sign Up",
    desc: "Create your account and choose your role — contributor or maintainer.",
  },
  {
    step: "02",
    title: "Report Issues",
    desc: "Submit detailed bug reports or feature requests with type and description.",
  },
  {
    step: "03",
    title: "Track & Resolve",
    desc: "Maintainers triage, update status, and drive issues to resolution.",
  },
];
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-900">
      ...
      <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden pt-16">
        ...
        <div
          className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-purple-300/20 dark:bg-purple-600/10 rounded-full blur-3xl animate-float"
        ...
        <div className="relative max-w-5xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-slate-500 dark:text-slate-400 max-w-2xl mx-auto mb-10 leading-relaxed">
            Bugify helps software teams report issues, request features, and
            drive them to resolution — with a clean role-based workflow built
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-500 dark:text-slate-400 text-lg max-w-2xl mx-auto">
              Built with a focus on simplicity and power, so teams can focus on
              shipping rather than managing tools.
            </p>
          </div>
      ...
      <section className="py-24 px-4 bg-slate-50 dark:bg-slate-950">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-slate-500 dark:text-slate-400 mb-8">
            Get product updates, team tips, and release notes in your inbox. No
            spam.
          </p>
          <form
      ...
      <section className="py-24 px-4 bg-gradient-to-br from-indigo-600 to-purple-700 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-indigo-200 text-lg mb-10 max-w-xl mx-auto">
            Join hundreds of dev teams already using Bugify to track and resolve
