    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 dark:from-slate-950 dark:via-slate-900 dark:to-indigo-950 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <Link
            href="/"
            className="inline-flex items-center justify-center w-14 h-14 bg-indigo-600 rounded-2xl mb-4 shadow-lg shadow-indigo-200 dark:shadow-indigo-900"
          >
          ...
          <p className="text-slate-500 dark:text-slate-400 mt-2">
            Join your team on Bugify today
          </p>
        </div>
        ...
        <div className="card p-8">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 dark:text-slate-500 mt-2">
                {form.role === "maintainer"
                  ? "Maintainers can update, delete, and change status of any issue."
                  : "Contributors can create and manage their own issues."}
              </p>
            </div>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs text-slate-400">
              <span className="bg-white dark:bg-slate-800 px-3">
                or continue with
              </span>
            </div>
          </div>
